...
(function (Personas) {
    ...
    window.onload = function () {
        ...
        //ELIMINAR TODO
        (_f = document.getElementById("btnClearAll")) === null || _f === void 0 ? void 0 : _f.addEventListener("click", deleteAll);
    };
    ...
    function getValuesOfElements() {
        ...
        array[3] = (document.getElementById("selectSexo").value).toString();
        return array;
    }
    ...
    function showFields() {
        ...
        var sexo = document.getElementById("checkSexo");
        if (id.checked) {
    ...
    function searchBySexo(list, value) {
        return new Promise(function (resolve) {
            var newList = list.filter(function (obj) { return obj.getSexo() == value; });
            resolve(newList);
        });
    }
    Personas.searchBySexo = searchBySexo;
    function Search(value) {
        ...
        return new Promise(function (resolve, reject) {
            if (list == "Todos") {
                ...
                resolve(searchBySexo(arrayList, list));
            }
        });
    }
